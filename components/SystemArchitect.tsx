...
const SystemArchitect: React.FC = () => {
  ...
  const handleDownload = () => {
      ...
      link.href = url;
      link.download = `system_architect_schematic_${Date.now()}.svg`;
      link.click();
  };
  ...
  return (
    <div className="max-w-[1800px] mx-auto space-y-6 lg:space-y-8 pb-12 h-[calc(100vh-100px)] flex flex-col">
       ...
       <div className="flex items-center gap-6 mb-4 border-b border-barker-gold/20 pb-6 shrink-0">
        ...
        <div>
          <h2 className="text-4xl font-display font-bold text-white mb-2 tracking-tight">System Architect</h2>
          <p className="text-gray-500 font-mono text-xs uppercase tracking-widest">
            Visual Case Study Builder & System Design Solver.
          </p>
        </div>
      </div>
